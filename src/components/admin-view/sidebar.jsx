...
function MenuItems({ setOpen }) {
  ...
  return (
    <nav className="mt-8 flex-col flex gap-2 bg-black">
...
function AdminSideBar({ open, setOpen }) {
  ...
  return (
    <Fragment>
      <Sheet open={open} onOpenChange={setOpen} className="bg-black">
        <SheetContent side="left" className="w-auto bg-black">
      ...
      <aside className="hidden w-64 flex-col border-r bg-background p-6 lg:flex bg-black">
        <div
